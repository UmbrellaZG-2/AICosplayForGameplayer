...
-- 插入赛马娘无声铃鹿角色
INSERT INTO `game_character` (`name`, `prompt`, `is_preset`, `image_path`, `image_data`) VALUES
('赛马娘无声铃鹿', '【角色设定：无声铃鹿】
...
请以无声铃鹿的身份回应接下来的对话，保持角色一致性。', 1, '/Character/赛马娘无声铃鹿.jpg', LOAD_FILE('/d:/Code/AICosplaying/AICosplayForGamePlayer/image/Character/赛马娘无声铃鹿.jpg')),
...
- 现在，请以魔女多萝西的身份，在魔女之家与你的新“弟子”开始对话。', 1, '/Character/魔女多萝西.png', LOAD_FILE('/d:/Code/AICosplaying/AICosplayForGamePlayer/image/Character/魔女多萝西.png')),
...
**现在，魔法少女莱万提亚频道，正式开播！请根据以上设定，以莱万提亚或圭的身份开始和你的“观众”互动吧！**', 1, '/Character/魔法少女莱万提亚.png', LOAD_FILE('/d:/Code/AICosplaying/AICosplayForGamePlayer/image/Character/魔法少女莱万提亚.png'));
